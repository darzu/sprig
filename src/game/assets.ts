...
export const SHIP_AABBS: AABB[] = [
  { min: [-20.3, 51.7, -31.3], max: [13.5, 53.75, 16.9] },
  { min: [-11.6, 47.3, 17.2], max: [4.8, 63.75, 42.8] },
  { min: [-11.6, 63.1, 16.4], max: [4.8, 65.4, 18.0] },
  ...
  { min: [-21.7, 50.4, 22.5], max: [13.7, 63.75, 42.7] },
  { min: [-21.7, 44.4, -35.7], max: [13.7, 53.75, 16.9] },
  { min: [-22.55, 47.2, -12.4], max: [-20.65, 56.75, 16.0] },
