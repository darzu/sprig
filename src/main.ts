...
import { initGrayboxAR } from "./graybox/graybox-action-roguelike.js";
...
const ALL_GAMES = [
  ...
  "mp",
  "graybox-sunless",
  "graybox-action-roguelike",
] as const;
const GAME: typeof ALL_GAMES[number] = "graybox-action-roguelike";
...
async function startGame(localPeerName: string, host: string | null) {
  ...
  else if (GAME === "graybox-action-roguelike") initGrayboxAR();
