...
export module mat4 {
  ...
  export const IDENTITY: ReadonlyMat4;

  // export const IDENTITY: mat4 = mat4.identity(mat4.create());
  /**
...
export module quat {
   ...
   * @returns {quat} out
   */
  export function rotationTo(out: quat, a: ReadonlyVec3, b: ReadonlyVec3): quat;
  /**
