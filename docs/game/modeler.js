...
import { PhysicsBroadCollidersDef, PhysicsResultsDef, PhysicsStateDef, } from "../physics/nonintersection.js";
import { PositionDef, ScaleDef } from "../physics/transform.js";
import { CameraViewDef, RenderableConstructDef, } from "../render/renderer.js";
...
function registerAABBBuilder(em) {
    em.registerSystem(null, [InputsDef, ModelerDef, AssetsDef, PhysicsBroadCollidersDef], (_, res) => {
        // create a new box
        if (res.inputs.keyClicks["b"]) {
            if (res.inputs.keyDowns["shift"]) {
                ...
                const aabbs = bs.map((b) => res._physBColliders.colliders[b._phys.worldAABBs[0]].aabb);
