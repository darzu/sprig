...
export function registerToolPickupSystem(em) {
    em.registerSystem([ToolDef, InteractingDef], [DetectedEventsDef], (hats, resources) => {
...
export function registerToolDropSystem(em) {
...
registerEventHandler("tool-pickup", {
    ...
    legalEvent: (em, entities) => {
        ...
        return (player !== undefined && tool !== undefined && player.player.tool === 0);
    },
