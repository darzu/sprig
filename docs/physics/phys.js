...
import { registerPhysicsContactSystems, registerPhysicsStateInit, registerUpdateLocalPhysicsAfterRebound, registerUpdateWorldAABBs, } from "./nonintersection.js";
...
export function computeContactData(a, aLastPos, b, bLastPos) {
    let dist = -Infinity;
    let dim = -1;
    let dir = 0;
...
export function computeReboundData(a, aLastPos, aCurrPos, b, bLastPos, bCurrPos, itr) {
